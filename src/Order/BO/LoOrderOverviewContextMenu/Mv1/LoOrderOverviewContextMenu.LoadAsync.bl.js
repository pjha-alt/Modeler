...
if (syncStatus === BLConstants.Order.NOT_SYNCABLE && orderId.startsWith("Local_")){
  enableDelete = "1";
         ...
         (sdoSubtype===BLConstants.Order.DOCUMENT_TYPE_DELIVERY && bCallIsReadOnly) || !isResponsible || (syncStatus === BLConstants.Order.NOT_SYNCABLE && !orderId.startsWith("Local_") || (callStatus === "Planned" && isDSDMode))){
  enableDelete = "0";
}

if ((mobilityRelevant === "0") || (sdoSubtype===BLConstants.Order.DOCUMENT_TYPE_DELIVERY) || ((callStatus === "Planned" || callStatus === "Completed") && isDSDMode) || isVisitReadOnly){
  enableCopy = "0";
}
